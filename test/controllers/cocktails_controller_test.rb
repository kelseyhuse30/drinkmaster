...
class CocktailsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cocktail" do
    assert_difference('Cocktail.count') do
      post cocktails_url, params: { cocktail: { creator_id: @cocktail.creator_id, custom: @cocktail.custom, glass: @cocktail.glass, instructions: @cocktail.instructions, name: @cocktail.name } }
    end
  ...
  test "should update cocktail" do
    patch cocktail_url(@cocktail), params: { cocktail: { creator_id: @cocktail.creator_id, custom: @cocktail.custom, glass: @cocktail.glass, instructions: @cocktail.instructions, name: @cocktail.name } }
